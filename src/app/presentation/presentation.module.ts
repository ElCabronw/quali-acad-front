...
const routes: Routes = [
  ...
  {
    path: 'dados-academicos/view/:id', component: DadosAcademicosViewComponent
  },
  {
    path: 'instituicoes', component: InstituicoesComponent
  },
  {
    path: 'instituicoes/view/:id', component: InstituicoesViewComponent
  },
  {
  ...
  @NgModule({
    declarations: [LoginComponent,InstituicoesViewComponent,HomeComponent,NavbarComponent,MenubarComponent,DadosAcademicosComponent,DadosAcademicosViewComponent,InstituicoesComponent],
    imports: [
    ...
    exports: [InstituicoesViewComponent,InstituicoesComponent,LoginComponent,HomeComponent,NavbarComponent,MenubarComponent,DadosAcademicosComponent,DadosAcademicosViewComponent],
    providers: [
      MessageService,
      IesRepository,
      IesService,
